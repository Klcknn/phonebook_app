# Terraform-Project : Phonebook Application (Python Flask) deployed on AWS Application Load Balancer with Auto Scaling and Relational Database Service using Terraform
...
- Step 1: Download or clone project definition from `Techpro` repo on Github
